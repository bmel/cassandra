...
public interface IAuthorizer
{
     ...
     * @return Set of permissions (and their constraints) of the user on the resource.
     * Should never return null. Use an empty {@link PermissionSet} instead.
     */
    PermissionSet authorize(AuthenticatedUser user, IResource resource);
